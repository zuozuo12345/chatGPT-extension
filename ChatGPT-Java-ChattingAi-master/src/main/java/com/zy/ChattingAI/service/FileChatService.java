...
public interface FileChatService {
     ...
     * @return
     */
    ChatGPTResp chatWithFile(String userId, Integer sessionId, String message, String apiKey, ChatGPTReq chatGPTReq,
            boolean usePinecone);
     ...
     * @param usePinecone
     */
    void streamChatWithFile(String userId, Integer sessionId, String message, String apiKey, ChatGPTReq chatGPTReq,
            SseEmitter sseEmitter, boolean usePinecone);
