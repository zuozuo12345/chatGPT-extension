...
import com.zy.ChattingAI.dto.ChatWithFileRequest;
import com.zy.ChattingAI.dto.SessionChatRequest;
import com.zy.ChattingAI.dto.StreamSessionChatRequest;
...
import com.zy.ChattingAI.service.FileChatService;
...
import com.zy.ChattingAI.utils.SnowflakeIdGenerator;
...
public class FileChatController {
    ...
    public ReturnResult dropCollection(@RequestParam(value = "userId") String userId,
        ...
        return fileChatService.dropCollection(userId, sessionId, usePinecone) ? ReturnResult.ok()
                : ReturnResult.error();
    }
}
