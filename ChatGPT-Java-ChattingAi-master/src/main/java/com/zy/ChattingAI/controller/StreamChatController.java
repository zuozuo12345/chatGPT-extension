...
import com.zy.ChattingAI.dto.StartGameStreamSessionRequest;
import com.zy.ChattingAI.dto.StreamOneShotChatRequest;
...
public class StreamChatController {
    ...
    public ReturnResult streamSessionChat(@RequestBody @Valid StreamSessionChatRequest req) {
        ...
        chatService.streamSessionChat(
                req.getUserId(), req.getSessionId(), gptReq, req.getMessage(), apiKey, sseEmitter,
