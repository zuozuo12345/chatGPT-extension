package com.zy.ChattingAI.api.pinecone;
...
public class PineconeApi {
     ...
     * TODO
     */
    private static final String PINECONE_API_URL = "https://ai-eb775d0.svc.us-west4-gcp.pinecone.io";
    ...
    public static String insertEmbedding(PineconeInsertReq pineconeInsertReq, String apiKey) {
        ...
        Request request = new Request.Builder()
                ...
                .post(RequestBody.create(MediaType.parse(ContentType.JSON.getValue()),
                        JSONUtil.parseObj(pineconeInsertReq).toString()))
    ...
    public static PineconeQueryResp queryEmbedding(PineconeQueryReq pineconeQueryReq, String apiKey) {
        ...
        Request request = new Request.Builder()
                ...
                .post(RequestBody.create(MediaType.parse(ContentType.JSON.getValue()),
                        JSONUtil.parseObj(pineconeQueryReq).toString()))
                .header("accept", "application/json")
                .header("content-type", "application/json")
                .header("Api-Key", apiKey)
                .build();
    ...
    public static String deleteEmbedding(PineconeDeleteReq pineconeDeleteReq, String apiKey) {
        ...
        Request request = new Request.Builder()
                ...
                .post(RequestBody.create(MediaType.parse(ContentType.JSON.getValue()),
                        JSONUtil.parseObj(pineconeDeleteReq).toString()))
                .header("accept", "application/json")
                .header("content-type", "application/json")
                .header("Api-Key", apiKey)
                .build();
