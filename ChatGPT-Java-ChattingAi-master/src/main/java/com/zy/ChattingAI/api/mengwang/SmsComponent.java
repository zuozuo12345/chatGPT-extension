package com.zy.ChattingAI.api.mengwang;
...
import com.zy.ChattingAI.dto.Result;
...
public class SmsComponent {
    ...
    // String result =
    // HttpClientUtil.post(url,body,"application/x-www-form-urlencoded","GBK",
    // 10000, 10000);
    ...
    public Result send(String phone, String code) throws Exception {
        ...
        String context = "Hello, dear user! Your verification code: " + code
                + ",which is valid for five minutes. Wish you have a nice day!";
    ...
    //
    // //返回ok
    // UserServiceImpl.log.debug("Send verification code successfully，Verification
    // code:{}",code);
    // return Result.ok();
    // }
