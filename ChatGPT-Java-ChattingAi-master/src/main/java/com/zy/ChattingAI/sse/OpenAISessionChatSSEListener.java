...
import com.zy.ChattingAI.utils.SpringUtil;
...
public class OpenAISessionChatSSEListener extends EventSourceListener {
     ...
     */
    public OpenAISessionChatSSEListener(SseEmitter sseEmitter, SessionChatRecordEntity askRecord, String collectionName,
